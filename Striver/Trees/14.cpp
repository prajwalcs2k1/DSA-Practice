// Write a C++ program to print the Top View of the given binary tree
...
void topView(Node* root, int *minHD, int *maxHD, unordered_map<int, int> &mp){
    if(!root) return;
